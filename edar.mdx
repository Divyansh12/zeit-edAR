...
<div style={{  margin:"0px 0px 0px -500px",color: 'cornflowerblue' }}>
...
<Image style={{ margin:"0px 300px 0px 0px",padding:"0px", width:"300px", height:"700px" }}  src='images/Chemistry1.png' />
