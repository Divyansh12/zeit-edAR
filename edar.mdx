...
<div style={{  margin:"0px 0px 200px -500px",color: 'cornflowerblue' }}>
...
<Image style={{ margin:"-200px 200px 0px 500px",padding:"0px", width:"300px", height:"700px" }}  src='images/Chemistry1.png' />
