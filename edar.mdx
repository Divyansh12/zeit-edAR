...
<div style={{  margin:"0px 0px -150px -700px",color: 'cornflowerblue' }}>
...
<Image style={{ margin:"-300px 0px 0px 600px",padding:"0px", width:"300px", height:"700px" }}  src='images/Chemistry1.png' />
