...
<div style={{  margin:"0px 0px -350px -1000px",color: 'cornflowerblue' }}>
...
<Image style={{ margin:"-300px 0px 0px 800px",padding:"0px", width:"300px", height:"700px" }}  src='images/Chemistry1.png' />
