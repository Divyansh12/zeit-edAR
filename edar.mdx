...
<div >
  ...
  <ul style={{listStyle: 'none'}}>
    <Appear>
    <li><h1>edAR uses augmented reality to visualise complex concepts which can now be learned much easily.</h1></li>
    <li><h1>Compared to reading long notes,watching multiple videos or going through courses.</h1></li>
  </Appear>
