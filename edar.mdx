...
<div style={{  margin:"0px 0px -250px -850px",color: 'cornflowerblue' }}>
...
<Image style={{ margin:"-300px 0px 0px 400px",padding:"0px", width:"300px", height:"700px" }}  src='images/Chemistry1.png' />
